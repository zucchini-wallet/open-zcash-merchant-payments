...
```
node scripts/create-challenge.mjs merchants/example.json registry-id https://shop.example.com payments-1
```
...
```
node scripts/verify-domain.mjs merchants/example.json proof.jws trusted-challenge.json
```
